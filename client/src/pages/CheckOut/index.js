...
const ShoppingCartDemo = () => {
  ...
  scheme.configureInsetSidebar((builder) => {
    builder.create('insetSidebar', { anchor: 'right' }).registerAbsoluteConfig('md', {
      width: '33%',
    });
  });
  scheme.configureEdgeSidebar((builder) => {
    builder.create('edgeSidebar', { anchor: 'right' }).registerTemporaryConfig('xs', {
      width: '88%',
    });
  });
  return (
        ...
        {({ setOpen, state: { sidebar } }) => {
          ...
          return (
            <>
              ...
              <DrawerSidebar PaperProps={{ className: styles.edgeSidebarBody }} sidebarId={'edgeSidebar'}>
                <DailyCheckout />
              </DrawerSidebar>
              <Content>
                <InsetContainer
                  rightSidebar={
                    <InsetSidebar sidebarId={'insetSidebar'} classes={{ paper: styles.sidebarBody }}>
                      <DailyCheckout />
                    </InsetSidebar>
                  }>
                  <DailyCart />
